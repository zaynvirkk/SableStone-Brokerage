...
def test_production_credentials_are_receipt_fingerprint_and_revocation_bound():
    ...
    for claim in ("fingerprint=bound", "wrong_secret=blocked", "wrong_scope=blocked", "wrong_provider=blocked", "missing=blocked", "revocation=checked", "self_assertion=removed"):
