...
export interface RecurringCandidate { readonly relationshipId: string;readonly priorFeeLockId:string;readonly offerId:string;readonly offerVersion:number;readonly authorizationDemandId:string;readonly authorizationDemandVersion:number;readonly status:RecurringCandidateStatus; }
export function createRecurringCandidate(relationship:ProtectedRelationship,priorLock:FeeLock,offer:SupplierOffer,demand:BuyerDemand,authorization:StandingDemandAuthorization,now:string):RecurringCandidate{
 ...
 return Object.freeze({relationshipId:relationship.relationshipId,priorFeeLockId:priorLock.feeLockId,offerId:offer.offerId,offerVersion:offer.version,authorizationDemandId:authorization.demandId,authorizationDemandVersion:authorization.demandVersion,status:"ECONOMICS_PENDING"});
}
